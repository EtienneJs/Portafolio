...
import proyect from '../Imgs/project.jpg'
...
export const ProyectsScreens = () => {
  ...
  <div className="card-body">
    ...
    <a href="https://countrysapi.netlify.app/" target="_blank"  className="btn btn-primary me-1">Ir a la pagina</a>
    <a href="https://github.com/eter19/KimChallenge" target="_blank"  className="btn btn-primary">Ir al repositorio</a>
  </div>
    </div>
    <div className="card">
  ...
  <div className="card-body">
    ...
    <a href="https://github.com/eter19/Portafolio" target='_blank' className="btn btn-primary">Ir al repositorio</a>
  </div>
    </div>
    <div className="card">
  <img src={proyect2} className="imgClass" alt="..."/>

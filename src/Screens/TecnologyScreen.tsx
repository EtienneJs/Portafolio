...
import iconSweetAlert from '../Imgs/SweetAlert2.png'
...
export const TecnologyScreen = () => {
  return (
      <div className=''>
    <h2 className='text-center mb-3'> Tecnologias </h2>
    ...
    <div className='twoCard'>
      ...
      <div className='card_custom'> <img className='iconTwo ' src={iconSweetAlert} alt='iconSweet'/></div>
